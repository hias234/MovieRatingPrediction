...
public class Stemmer {
	 ...
	 * the internal buffer can be retrieved by getResultBuffer and getResultLength (which
	...
	/*
	 * m() measures the number of consonant sequences between 0 and j. if c is a consonant
	...
	/*
	 * cvc(i) is true <=> i-2,i-1,i has the form consonant - vowel - consonant and also if
	 * the second c is not w,x or y. this is used when trying to restore an e at the end
	 * of a short word. e.g.
	 * 
	...
	/*
	 * step3() maps double suffices to single ones. so -ization ( = -ize plus -ation) maps
	 * to -ize etc. note that the string before the suffix must give m() > 0.
	 */
	 ...
	 * if the stemming process resulted in a word different from the input. You can
